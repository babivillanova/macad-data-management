...
function init() {
    ...
    camera = new THREE.PerspectiveCamera( 20, window.innerWidth / window.innerHeight, 0.1, 500 )
    ...
    loader.load( 'AirCond.3dm', function ( object ) {
...
function onClick( event ) {
    ...
    scene.traverse((child, i) => {
        if (child.isMesh) {
            child.material.color.set( 'original' ) 
        }
    });
